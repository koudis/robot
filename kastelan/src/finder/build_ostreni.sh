...
bfin-uclinux-g++ -I opencv/include/ -I src/common src/finder/ostreni.cpp src/finder/finder.cpp src/finder/video_driver.cpp src/common/our_time.cpp src/common/variable_loader.cpp -DARCH_ARM\
